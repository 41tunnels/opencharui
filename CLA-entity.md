# 41tunnels Entity Contributor License Agreement

Based on Harmony (HA-CLA-E-ANY) Version 1.0 — [harmonyagreements.org](https://www.harmonyagreements.org/)

Thank you for your interest in contributing to software projects managed by
41tunnels ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. Use this version if You are contributing on behalf of
Your employer or another legal entity, rather than as an individual — see
the [Individual CLA](CLA.md) otherwise. To make this document effective,
indicate your agreement as described in
[CONTRIBUTING.md](CONTRIBUTING.md#signing-the-cla). This is a legally
binding document, so please read it carefully before agreeing to it. The
Agreement covers all software projects managed by Us under the 41tunnels
org (github.com/41tunnels), including Amallo, Relay and OpenCharUI.
...
the Copyright in the entire work of authorship, please contact us at
hello@41tunnels.com before submitting.
...
sublicense such rights through multiple tiers of sublicensees, to
reproduce, modify, display, perform and distribute the Contribution as part
...
(d) You have contacted us at hello@41tunnels.com if You do not own the
...
laws of Austria excluding its conflicts of law provisions. Under certain
...
Stephan Schober, operating as 41tunnels
Fuchsschweif 35, 4230 Pregarten, Austria
hello@41tunnels.com
