# 41tunnels Individual Contributor License Agreement

Based on Harmony (HA-CLA-I-ANY) Version 1.0 — [harmonyagreements.org](https://www.harmonyagreements.org/)

Thank you for your interest in contributing to software projects managed by
41tunnels ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, indicate your
agreement as described in [CONTRIBUTING.md](CONTRIBUTING.md#signing-the-cla).
This is a legally binding document, so please read it carefully before
agreeing to it. The Agreement covers all software projects managed by Us
under the 41tunnels org (github.com/41tunnels), including Amallo, Relay and
OpenCharUI.
...
sign the [Entity version](CLA-entity.md) of this document. If You are less
than eighteen years old, please have Your parent or guardian sign the
Agreement.
